...
namespace BaiTap1ADONET.DataAccessLayer
{
    ...
    {
        private string connectionString = @"Data Source=LAPTOP-M863II0B\SQLEXPRESS;Initial Catalog=AnimalDB;Integrated Security=True;MultipleActiveResultSets=True";
